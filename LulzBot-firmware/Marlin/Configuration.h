...
#define PID_MAX 74 // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  #define PID_INTEGRAL_DRIVE_MAX 70  //limit for the integral term should be set under PID_MAX term
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100.5,100.5,800,829}  // default steps per unit for Ultimaker
